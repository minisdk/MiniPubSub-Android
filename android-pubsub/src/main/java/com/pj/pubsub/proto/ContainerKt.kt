...
public inline fun container(block: com.pj.pubsub.proto.ContainerKt.Dsl.() -> kotlin.Unit): com.pj.pubsub.proto.NativePubSub.Container =
  com.pj.pubsub.proto.ContainerKt.Dsl._create(com.pj.pubsub.proto.NativePubSub.Container.newBuilder()).apply { block() }._build()
/**
...
public object ContainerKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.pj.pubsub.proto.NativePubSub.Container.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.pj.pubsub.proto.NativePubSub.Container.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.pj.pubsub.proto.NativePubSub.Container = _builder.build()
     ...
     */
     public val containers: com.google.protobuf.kotlin.DslMap<kotlin.String, com.pj.pubsub.proto.NativePubSub.Container, ContainersProxy>
      @kotlin.jvm.JvmSynthetic
    ...
    public fun com.google.protobuf.kotlin.DslMap<kotlin.String, com.pj.pubsub.proto.NativePubSub.Container, ContainersProxy>
      .put(key: kotlin.String, value: com.pj.pubsub.proto.NativePubSub.Container) {
    ...
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslMap<kotlin.String, com.pj.pubsub.proto.NativePubSub.Container, ContainersProxy>
      .set(key: kotlin.String, value: com.pj.pubsub.proto.NativePubSub.Container) {
         put(key, value)
       }
    /**
     * `map<string, .Container> containers = 6;`
    ...
    public fun com.google.protobuf.kotlin.DslMap<kotlin.String, com.pj.pubsub.proto.NativePubSub.Container, ContainersProxy>
      .putAll(map: kotlin.collections.Map<kotlin.String, com.pj.pubsub.proto.NativePubSub.Container>) {
...
@kotlin.jvm.JvmSynthetic
public inline fun com.pj.pubsub.proto.NativePubSub.Container.copy(block: `com.pj.pubsub.proto`.ContainerKt.Dsl.() -> kotlin.Unit): com.pj.pubsub.proto.NativePubSub.Container =
  `com.pj.pubsub.proto`.ContainerKt.Dsl._create(this.toBuilder()).apply { block() }._build()
